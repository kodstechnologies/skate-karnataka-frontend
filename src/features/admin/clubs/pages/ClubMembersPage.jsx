...
export const ClubMembersPage = () => {
  ...
  const { members, isLoading, fetchMembers, deleteMember, pagination } = useClubMembersStore();
  ...
  useEffect(() => {
    fetchMembers(clubId, { search: debouncedSearch, page: page + 1, limit: rowsPerPage });
  }, [clubId, fetchMembers, debouncedSearch, page, rowsPerPage]);
        ...
        <Stack spacing={2} sx={{ position: "relative", zIndex: 1 }}>
          ...
          <Box>
            ...
            <Typography sx={{ color: "rgba(255,255,255,0.82)", lineHeight: 1.7, maxWidth: 580 }}>
              View and manage all members registered under this club.
            </Typography>
          </Box>
        ...
        >
          <Box>
            ...
            <Typography sx={{ mt: 0.75, color: "#8d7f7b" }}>
              Search, add, edit, or remove members for this club.
            </Typography>
          </Box>

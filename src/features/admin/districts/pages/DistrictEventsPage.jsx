...
const getEventCardPalette = (event) => {
  ...
  return {
    ...
    panel: isLight ? "rgba(255,255,255,0.45)" : "rgba(0,0,0,0.16)",
    panelBorder: isLight ? "rgba(47,40,41,0.12)" : "rgba(255,255,255,0.14)",
    text,
    muted,
                      ...
                      <Stack spacing={1.25} sx={{ mt: "auto", pt: 1.5, flexShrink: 0 }}>
                        {canApprove && isApprovalPending && (
                          <EventReviewPanel
                            ...
                            message="This district event is waiting for your review."
                          >
                            <Button
                              variant="contained"
                              size="small"
                        ...
                        {canApprove && isDeletePending && (
                          <EventReviewPanel
                            ...
                            message="The district asked to remove this event. Approve to delete, or cancel to keep it live."
                          >
                            <Button
                              variant="contained"
                              size="small"
